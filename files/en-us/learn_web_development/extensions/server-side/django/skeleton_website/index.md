...
1. You will (_not yet_ it's in the next section below!) use the `uv run python -m django startproject` command to generate a project folder, the basic file templates, and **manage.py**, which serves as your project management script.
